...
function startLanguageServer(port, csrf, headless) {
    return new Promise((resolve, reject) => {
        const doStart = (proxyString) => {
            ...
            // Parse proxyString and inject into environment
        ...
        const urlForProxy = 'https://generativelanguage.googleapis.com';
        electron_1.session.defaultSession.resolveProxy(urlForProxy)
            .then((proxyString) => {
                doStart(proxyString);
            })
            .catch((err) => {
